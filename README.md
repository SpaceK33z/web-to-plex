...
Optionally you can configure CouchPotato or Radarr in the options. After that, you can immediately add a movie to CouchPotato/Radarr, with one click, right from Movieo, IMDb or Trakt.tv.
